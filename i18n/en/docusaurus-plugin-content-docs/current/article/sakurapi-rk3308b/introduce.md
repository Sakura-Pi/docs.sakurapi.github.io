...
#### LLVMPipe GLSL
We use LLVMPipe to render ShaderToy shaders, conducting stress tests at a CPU frequency of 1.3GHz. Without any additional cooling, the junction temperature reaches around 140 degrees Celsius.
